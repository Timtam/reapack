...
-- @links
--   GitHub repository https://github.com/Timtam/IntelliFreeze
--   Donation https://paypal.me/ToniRonaldBarth
-- @provides
--   [main] timtam_IntelliFreeze/timtam_IntelliFreeze Freeze all selected tracks to mono recursively.lua https://github.com/Timtam/IntelliFreeze/raw/v$version/timtam_IntelliFreeze/timtam_IntelliFreeze%20Freeze%20all%20selected%20tracks%20to%20mono%20recursively.lua
--   [main] timtam_IntelliFreeze/timtam_IntelliFreeze Freeze all selected tracks to multi-channel recursively.lua https://github.com/Timtam/IntelliFreeze/raw/v$version/timtam_IntelliFreeze/timtam_IntelliFreeze%20Freeze%20all%20selected%20tracks%20to%20multi-channel%20recursively.lua
--   [main] timtam_IntelliFreeze/timtam_IntelliFreeze Freeze all selected tracks to stereo recursively.lua https://github.com/Timtam/IntelliFreeze/raw/v$version/timtam_IntelliFreeze/timtam_IntelliFreeze%20Freeze%20all%20selected%20tracks%20to%20stereo%20recursively.lua
--   [main] timtam_IntelliFreeze/timtam_IntelliFreeze Unfreeze all selected tracks recursively.lua https://github.com/Timtam/IntelliFreeze/raw/v$version/timtam_IntelliFreeze/timtam_IntelliFreeze%20Unfreeze%20all%20selected%20tracks%20recursively.lua
--   [nomain] timtam_IntelliFreeze/timtam_IntelliFreeze.lua https://github.com/Timtam/IntelliFreeze/raw/v1.1/timtam_IntelliFreeze/timtam_IntelliFreeze.lua
-- @changelog
--   - consider takes with FX to be frozen too
-- @about
--   ## About The Project
--
