...
-- @version 1.0
-- @about When there is only one selected item in the project, moves to the previous item and selects that instead.  Works even if an envelope has the focus.
...
if i-1 == 0 then Speak( "First item on track already selected" ) return end 

--Is there an item before the selected one?
item2 = reaper.GetTrackMediaItem( track, i-2 )
