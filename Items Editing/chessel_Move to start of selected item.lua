-- @description Move to start of selected item
-- @version 1.0
-- @about When there is only one selected item in the project, moves the edit cursor to the start of the item.  Works even if an envelope is selected. 
