...
-- @provides
--   [main] . > Scan for Silence/Move to beginning of next silence in selected item.lua
--   [main] . > Scan for Silence/Move to beginning of previous silence in selected item.lua
--   [main] . > Scan for Silence/Move to end of next silence in selected item.lua
--   [main] . > Scan for Silence/Move to end of previous silence in selected item.lua
--   [main] . > Scan for Silence/Configure scan for silence.lua
-- changelog
--   Initial release
